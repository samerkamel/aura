...
@section('title', 'Create Internal Transaction Sequence')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Create Internal Transaction Sequence</h5>
                    <small class="text-muted">Create a new internal transaction numbering sequence</small>
                </div>
            ...
            <form action="{{ route('invoicing.internal-sequences.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <!-- Basic Information -->
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                       value="{{ old('name') }}" required placeholder="e.g., Default Internal Transaction Sequence">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="prefix" class="form-control @error('prefix') is-invalid @enderror"
                                       value="{{ old('prefix') }}" maxlength="10" required placeholder="e.g., INT, TRANS">
                                @error('prefix')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Short prefix for transaction numbers (max 10 characters)</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @error('starting_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">The first transaction will use this number</small>
                            </div>
                        </div>
                            ...
                            <div class="alert alert-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="mb-0">
                                            <li><code>{PREFIX}-{YEAR}-{NUMBER:6}</code> → <span class="badge bg-primary">INT-2025-000001</span></li>
                                            <li><code>{PREFIX}-{YEAR}-{MONTH}-{NUMBER:4}</code> → <span class="badge bg-primary">TRANS-2025-09-0001</span></li>
                                            <li><code>{PREFIX}{NUMBER:5}</code> → <span class="badge bg-primary">INT00001</span></li>
                                            <li><code>{PREFIX}-{NUMBER:3}</code> → <span class="badge bg-primary">INT-001</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="alert alert-light">
                                ...
                                <p class="mb-0"><strong>Next Transaction Number:</strong> <span id="preview-number" class="badge bg-success">INT-2025-000001</span></p>
                            </div>
                        </div>
                        <div class="col-md-4">
