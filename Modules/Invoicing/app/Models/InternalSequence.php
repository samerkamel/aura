...
/**
 * InternalSequence Model
 *
 * Manages internal transaction numbering sequences with configurable formats.
 * Supports sector-based and business unit-based sequences for internal accounting.
 */
class InternalSequence extends Model
{
    ...
    /**
     * Get transactions using this sequence.
     */
    ...
    public function generateTransactionNumber(): string
    {
        ...
        return $this->formatTransactionNumber($this->current_number);
    }

    /**
     * Preview what the next transaction number would be without incrementing.
     */
    public function previewNextTransactionNumber(): string
    {
        $nextNumber = $this->current_number + 1;
        return $this->formatTransactionNumber($nextNumber);
    }

    /**
     * Format transaction number with proper placeholder replacement.
     */
    private function formatTransactionNumber(int $number): string
    {
        $format = $this->format;
