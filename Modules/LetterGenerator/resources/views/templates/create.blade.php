...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Load existing content if any (for old() validation)
  ...
  <div class="col-xl">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Create New Letter Template</h5>
        <small class="text-muted float-end">Template Information</small>
      </div>
      <div class="card-body">
        ...
        <form action="{{ route('letter-templates.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <textarea class="d-none" id="content" name="content" required>{{ old('content') }}</textarea>
            @error('content')
          ...
          <div class="d-flex justify-content-between">
            ...
            <button type="submit" class="btn btn-primary">
              <i class="ti tabler-device-floppy me-1"></i>Save Template
            </button>
          </div>
