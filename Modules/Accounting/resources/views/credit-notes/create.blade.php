                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('accounting.credit-notes.index') }}" class="btn btn-outline-secondary">
                                <i class="ti tabler-arrow-left me-1"></i>Back to Credit Notes
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                    ...
                                    <select class="form-select @error('customer_id') is-invalid @enderror"
                                        ...
                                        @foreach($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                ...
                                                {{ old('customer_id', $selectedInvoice->customer_id ?? '') == $customer->id ? 'selected' : '' }}>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary w-100 mb-2">
                                <i class="ti tabler-device-floppy me-1"></i>Save Credit Note
                            </button>
