...
<div class="row">
    <div class="col-12">
        <form action="{{ route('accounting.estimates.update', $estimate) }}" method="POST" id="estimateForm">
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-0">Edit Estimate: {{ $estimate->estimate_number }}</h5>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control @error('client_email') is-invalid @enderror"
                                           ...
                                           value="{{ old('client_email', $estimate->client_email) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('client_address') is-invalid @enderror"
                                           ...
                                           value="{{ old('client_address', $estimate->client_address) }}"
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           id="title" name="title" value="{{ old('title', $estimate->title) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Brief description of this estimate">{{ old('description', $estimate->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control @error('issue_date') is-invalid @enderror"
                                           ...
                                           value="{{ old('issue_date', $estimate->issue_date->format('Y-m-d')) }}" required>
                                    @error('issue_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control @error('valid_until') is-invalid @enderror"
                                           ...
                                           value="{{ old('valid_until', $estimate->valid_until?->format('Y-m-d')) }}">
                                    @error('valid_until')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('vat_rate') is-invalid @enderror"
                                               ...
                                               value="{{ old('vat_rate', $estimate->vat_rate) }}"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="itemsTable">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-end">VAT (<span id="vatRateDisplay">{{ $estimate->vat_rate }}</span>%):</td>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror"
                                              ...
                                              placeholder="Notes and terms to appear on the estimate">{{ old('notes', $estimate->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('internal_notes') is-invalid @enderror"
                                              ...
                                              placeholder="Internal notes (not shown to client)">{{ old('internal_notes', $estimate->internal_notes) }}</textarea>
