                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select select2-customer @error('customer_id') is-invalid @enderror"
                                            ...
                                            data-selected="{{ old('customer_id', $selectedProject->customer_id ?? '') }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initCustomerSelect2() {
        ...
        const preSelected = $('#customer_id').data('selected');
        ...
        $('#customer_id').select2({
            ...
            if (data) {
                document.getElementById('client_name').value = data.name || data.text || '';
