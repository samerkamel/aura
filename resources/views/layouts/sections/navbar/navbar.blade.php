              ...
              @if (Auth::User() && class_exists('\Laravel\Jetstream\Jetstream') && Laravel\Jetstream\Jetstream::hasTeamFeatures())
                ...
                <li>
                  <a class="dropdown-item" href="{{ Auth::user() ? route('teams.show', Auth::user()->currentTeam->id) : 'javascript:void(0)' }}">
                    <i class="ti tabler-settings ti-md me-3"></i><span class="align-middle">Team Settings</span>
                  </a>
                </li>
                  ...
                  @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                    <li>
                      <a class="dropdown-item" href="{{ route('teams.create') }}">
                        <i class="ti tabler-user ti-md me-3"></i><span class="align-middle">Create New Team</span>
                      </a>
                    </li>
                  @endcan
                @endif
                ...
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-sm btn-danger d-flex" href="{{ Route::has('login') ? route('login') : url('auth/login-basic') }}">
                      ...
                      <i class="ti tabler-login ms-2 ti-14px"></i>
                    </a>
                  </div>
                </li>
              @endif
