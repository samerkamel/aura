...
<div class="row mb-6">
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-currency-dollar ti-32px"></i>
        <h5>Pricing</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-credit-card ti-32px"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-home ti-32px"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-gift ti-32px"></i>
        <h5>Refer & Earn</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-user ti-32px"></i>
        <h5>Edit User</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-file-text ti-32px"></i>
        <h5>Share Project</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-box ti-32px"></i>
        <h5>Create App</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-lock ti-32px"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6 mb-sm-0">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 text-heading ti tabler-brand-mastercard ti-32px"></i>
