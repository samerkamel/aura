  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
        ...
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="ti-sm ti tabler-link me-1_5"></i> Connections</a></li>
      </ul>
    </div>
    <div class="card">
      <div class="row">
            ...
            <div class="d-flex mb-4 align-items-center">
              ...
              <div class="flex-grow-1 row">
                ...
                <div class="col-5 text-end mt-sm-0 mt-2">
                  <button class="btn btn-icon btn-label-secondary"><i class='ti tabler-link ti-md'></i></button> </div>
              </div>
            </div>
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-shrink-0">
              ...
              <div class="flex-grow-1 row">
                <div class="col-7">
                  ...
                  <a href="{{config('variables.twitterUrl')}}" target="_blank" class="small">&#64;{{ (!empty(config('variables.creatorName')) ? config('variables.creatorName') : '') }}</a>
                </div>
                <div class="col-5 text-end mt-sm-0 mt-2">
                  <button class="btn btn-icon btn-label-danger"><i class='ti tabler-trash ti-md'></i></button> </div>
              </div>
            </div>
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-shrink-0">
              ...
              <div class="flex-grow-1 row">
                <div class="col-7">
                  ...
                  <a href="{{config('variables.instagramUrl')}}" target="_blank" class="small">&#64;{{ (!empty(config('variables.creatorName')) ? config('variables.creatorName') : '') }}</a>
                </div>
                <div class="col-5 text-end mt-sm-0 mt-2">
                  <button class="btn btn-icon btn-label-danger"><i class='ti tabler-trash ti-md'></i></button> </div>
              </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 row  align-items-center">
                ...
                <div class="col-5 text-end">
                  <button class="btn btn-icon btn-label-secondary"><i class='ti tabler-link ti-md'></i></button>
                </div>
              </div>
            </div>
            <!-- /Social Accounts -->
