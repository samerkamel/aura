...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold py-3 mb-0">Edit Department</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('administration.departments.show', $department) }}">{{ $department->name }}</a>
                    </li>
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('administration.departments.show', $department) }}" class="btn btn-outline-info">
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('administration.departments.update', $department) }}">
                        @csrf
                        @method('PUT')
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="ti ti-building me-2"></i>Department Preview
                    </h5>
                </div>
                <div class="card-body text-center">
                    ...
                    @if($department->head_of_department)
                        <p class="text-muted mb-0">{{ $department->head_of_department }}</p>
                    @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        <h6>Editing Department</h6>
                        <ul class="mb-0 ps-3">
                            <li>Department code must remain unique</li>
