...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold py-3 mb-0">Department Details</h4>
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('administration.departments.edit', $department) }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="info-container">
                        <ul class="list-unstyled">
                            <li class="mb-3">
                                <span class="fw-medium me-2">Department Code:</span>
                            ...
                            <li class="mb-3">
                                <span class="fw-medium me-2">Head of Department:</span>
                        ...
                        <div class="d-grid gap-2 mt-4">
                            <form method="POST" action="{{ route('administration.departments.toggle-status', $department) }}">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                            ...
                            <form method="POST" action="{{ route('administration.departments.destroy', $department) }}">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                            ...
                            <div class="alert alert-info">
                                ...
                                Cannot delete department with assigned contracts.
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted mb-0">This department has no contracts assigned yet.</p>
                        </div>
                    @endif
                </div>
            </div>
